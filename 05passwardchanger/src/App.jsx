...
function App() {
  ...
  const copyPasswordToClipboard = useCallback(()=>{
    ...
    passwardRef.current?.select(passward)
    passwardRef.current?.setSelectionRange(0,4)
  },[passward])
  ...
  useEffect(() =>{
    passwardGenerator()
  },[length, numAllowed, charAllowed, passwardGenerator])
      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          <button
            ...
            className="outline-none bg-gray-500 px-3 py-0.5 shrink-0"
          >
            copy
          </button>
        </div>
